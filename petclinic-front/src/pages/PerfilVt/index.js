...
export default function PerfilVt() {
  ...
  const handleSave = async () => {
    if (!nome || !email || !crmv) {
      Alert.alert("Aviso!", "Nome, email e CRMV são obrigatórios");
      return;
    }
  ...
  return (
    <ScrollView style={styles.scroll}>
      <View style={styles.container}>
        ...
        >
          <Text style={styles.message}>Perfil do Veterinário</Text>
        </Animatable.View>
